...
export default function SettingsPage() {
  ...
  const handleChangePassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Verificar contraseña actual + actualizar — estas dos operaciones son
      // de auth pura, no del modelo de datos, por lo que usan el singleton
      // de lib/supabase.ts directamente (igual que el login hace signInWithPassword)
        ...
        <div className="bg-[#050505] border border-white/10 p-8 rounded-2xl">
          ...
          <form onSubmit={handleChangePassword} className="space-y-4">
            ...
            <div>
              ...
              <input type="password" placeholder="Repetir contraseña" value={confirmPassword}
