...
// AQUI ESTA LA MAGIA DEL PASO 2: Importamos el cerebro desde su nueva casa neutral
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    // 4. ENVUELVE TU DISEÑO EN EL PROVEEDOR PARA REPARTIR LOS DATOS
